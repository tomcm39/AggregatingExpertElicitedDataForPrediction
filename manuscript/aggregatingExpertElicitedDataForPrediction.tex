...
% - recognizing and being transparent about quantifying uncertainty
% - studies that investigated the use/value in general and specific decision making scenarios
% - gave clear feedback to forecasts and decision makers using proper scoring rules
% - forecasts as condensenced inforation to guide decision makers
% - frequent forecasts, feedback fast, evaluation routine
% - past data is useful
% - forecasts are independent of the outcomes
% - education
